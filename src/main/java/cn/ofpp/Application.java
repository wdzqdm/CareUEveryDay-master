...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        // new 一个 女友
        GirlFriend girlFriend = new GirlFriend("程成宝贝",
                "辽宁省", "沈阳市", "1997-07-18", "2017-06-07", "oJdZX6-CWk3FdOGqbhx_iLolffuo");
        Wx.sendTemplateMessage(MessageFactory.resolveMessage(girlFriend));

        // new 一个 男友 也可单独针对一个friend设置模板ID 以达到不同人不同消息
        BoyFriend boyFriend = new BoyFriend("恩泽宝贝",
                "辽宁省", "沈阳市", "1998-01-02", "2017-06-07", "oJdZX6-CWk3FdOGqbhx_iLolffuo", "5t7-Ksy8_rw-QmUkxf8J7Pe-QLQ2rBc7RWJi_pSmeh4");
